...
export default function AuthStatus() {
  ...
  // 1. Loading state (smooth pulsing skeleton, prevents null crash)
  if (loading) {
    return (
      <div className="w-9 h-9 rounded-full bg-white/10 animate-pulse shrink-0 border border-white/5" />
    );
  }

  // 2. Logged In state (shows Avatar + Dropdown)
  if (user) {
    return (
  ...
  // 3. Guest / Logged Out state (shows reusable LoginButton)
  return (
